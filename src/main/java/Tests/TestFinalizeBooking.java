...
public class TestFinalizeBooking extends TestSetup {
    ...
    @Test
    public void performBooking() throws InterruptedException {
        ...
        //  ACT
        action.clickElement(homePagePopUp);  // not working.. need to click away manually
        ...
        action.clickElement(String.valueOf(button.get(2)));          // due to bad practices on the airbnb site.
